...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    user_subcategories: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
    ...
    BrewfatherURL: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
...
export interface ApiCarouselCarousel extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: 'Carousel (Pode editar)';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    image_position: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiGaleriaGaleria extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'galerias';
    displayName: 'Galeria (Pode editar)';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiMedalMedal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    medal: Attribute.Enumeration<['Ouro', 'Prata', 'Bronze']> &
      Attribute.Required;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::post.post', 'Titulo'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiUserSubcategoryUserSubcategory
  extends Schema.CollectionType {
  collectionName: 'user_subcategories';
  info: {
    singularName: 'user-subcategory';
    pluralName: 'user-subcategories';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::medal.medal': ApiMedalMedal;
      'api::post.post': ApiPostPost;
      'api::subcategory.subcategory': ApiSubcategorySubcategory;
      'api::user-subcategory.user-subcategory': ApiUserSubcategoryUserSubcategory;
    }
  }
}
